    ...
    private void unloadPlugin(String pluginName, CommandSender sender) throws Exception {
        ...
        for (Plugin plugin : manager.getPlugins()) {
            ...
            while (it.hasNext()) {
                ...
                if (!(entry.getValue() instanceof org.bukkit.command.PluginCommand)) continue;
                org.bukkit.command.PluginCommand command = (org.bukkit.command.PluginCommand) entry.getValue();
